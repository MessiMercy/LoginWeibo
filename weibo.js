function get_pass(rsaPubkey,password,nonce,servertime){
		var RSAKey = new sinaSSOEncoder.RSAKey();
		RSAKey.setPublic(rsaPubkey, "10001");
		password = RSAKey.encrypt([servertime, nonce].join("\t") + "\n" + password)
		//password = sinaSSOEncoder.hex_sha1("" + sinaSSOEncoder.hex_sha1(sinaSSOEncoder.hex_sha1(password)) + servertime + nonce)
		return password;
	}
